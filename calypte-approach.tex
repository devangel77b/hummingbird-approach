...
% PDF metadata
\usepackage{hyperref}
\hypersetup{pdftitle={Large area kinematics of the approach to a feeder in Anna's Hummingbirds (Calypte anna)}}
\hypersetup{pdfauthor={Marc Badger, Dennis Evangelista and Nir Sapir}}
\hypersetup{pdfsubject={biomechanics}}
\hypersetup{pdfkeywords={biomechanics, Anna's hummingbird, \emph{Calypte anna}, maneuvering, kinematics, hummingbird}}
